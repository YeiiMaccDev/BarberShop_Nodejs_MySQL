class Calendar {
    ...
    showCells() {
        ...
        for (let i = 0; i < this.cells.length; i++) {
            ...
            disabledClass = '';
            currentDataCell = this.cells[i].date.format('YYYY/MM/DD');
            ...
            // días fuera del mes
            if ( moment(currentDataCell).isSameOrBefore(currentDate) ) {
                disabledClass = 'grid__cell--disabled ';
            }

            if ( currentDate == currentDataCell ) {
                disabledClass = 'grid__cell--selectedToday ';
            }
